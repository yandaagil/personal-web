        ...
        <div className="about">
          ...
          <div className="about-right">
            <p>
              ...
              with a focus on Front-end development. Skilled in HTML, CSS,
            ...
            <p>
              ...
              experience and contribute to real-world projects while continuing
              to develop my skills and knowledge in the field of front-end
              development.
            </p>
            <Link
